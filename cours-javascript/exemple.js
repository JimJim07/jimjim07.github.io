...
let citations = [
    ...
    ["Agissez comme s’il était impossible d’échouer. La gratitude est la force créatrice la plus puissante.", "Audrey Garcia"],
    ["L’action est la clé fondamentale de tout succès.", "Pablo Picasso"],
    ["Apprends d'hier, vis pour aujourd'hui et espère pour demain.", "Julien Baptiste"],
    ["Si tu veux traversé la rivière ne demande pas ton chemin a l'alligator.", "Primael Roche"],
    ["Ce n'est qu'avec les yeux des autres que l'on peut bien voire ses defauts.", "Primael Roche"],
    ...
    do{
      ...
      h1.textContent = citations[nombreAleatoire][0];
      h2.textContent = citations[nombreAleatoire][1];   
  })